...
public class XsltTest {
    ...
    public Object[][] getTestData() {
        return new Object[][] {
            ...
            new Object[]{
                    new ClassPathResource("crafter/studio/upgrade/4.2.x/permission-mappings/permission-mappings-config-v4.2.1.xslt"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/permission-mappings-config/4.2/4.2.1/input.xml"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/permission-mappings-config/4.2/4.2.1/expected.xml"),
                    emptyMap()
            },
            new Object[]{
                    new ClassPathResource("crafter/studio/upgrade/4.2.x/4.2.1/system/global-permission-mappings-config.xslt"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.2.1/input.xml"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.2.1/expected.xml"),
                    emptyMap()
            }
        };
    }
