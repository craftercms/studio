...
public class XsltTest {
    ...
    public Object[][] getTestData() {
        return new Object[][] {
			...
			new Object[] {
					new ClassPathResource("crafter/studio/upgrade/4.2.x/system/global-permission-mappings-config-v4.2.0.18.xslt"),
					new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.2.0.18/input.xml"),
					new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.2.0.18/expected.xml"),
					emptyMap()
			},
			new Object[] {
					new ClassPathResource("crafter/studio/upgrade/4.2.x/config/config-list/config-list-v4.2.0.0.xslt"),
					new ClassPathResource("crafter/studio/upgrade/xslt/config-list/4.2.0.0/input.xml"),
					new ClassPathResource("crafter/studio/upgrade/xslt/config-list/4.2.0.0/expected.xml"),
					emptyMap()
			},
            new Object[] {
                    new ClassPathResource("crafter/studio/upgrade/4.3.x/permission-mappings/permission-mappings-config-v4.3.0.0.xslt"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/permission-mappings-config/4.3.0.0/input.xml"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/permission-mappings-config/4.3.0.0/expected.xml"),
                    emptyMap()
            },
            new Object[] {
                    new ClassPathResource("crafter/studio/upgrade/4.3.x/system/global-permission-mappings-config-v4.3.0.0.xslt"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.3.0.0/input.xml"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.3.0.0/expected.xml"),
                    emptyMap()
            },
			new Object[] {
					new ClassPathResource("crafter/studio/upgrade/4.3.x/system/global-permission-mappings-config-v4.3.0.1.xslt"),
					new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.3.0.1/input.xml"),
					new ClassPathResource("crafter/studio/upgrade/xslt/global-permission-mappings/4.3.0.1/expected.xml"),
					emptyMap()
			},
			new Object[] {
					new ClassPathResource("crafter/studio/upgrade/4.3.x/system/global-role-mappings-config-v4.3.0.1.xslt"),
					new ClassPathResource("crafter/studio/upgrade/xslt/global-role-mappings/4.3.0.1/input.xml"),
					new ClassPathResource("crafter/studio/upgrade/xslt/global-role-mappings/4.3.0.1/expected.xml"),
					emptyMap()
			}
        };
    }
	...
	@DataProvider(name = "ui4500TestData")
	public Object[][] uiTestData() {
		return new Object[][]{
				new Object[] {
						new ClassPathResource("crafter/studio/upgrade/4.5.x/config/ui/ui-v4.5.0.0.xslt"),
						new ClassPathResource("crafter/studio/upgrade/xslt/ui/v4.5/4.5.0.0/input.xml"),
						new ClassPathResource("crafter/studio/upgrade/xslt/ui/v4.5/4.5.0.0/expected.xml"),
						emptyMap()
				}
		};
	}

	@Test(dataProvider = "ui4500TestData")
	public void ui4500Test(Resource template, Resource content, Resource expected, Map<String, Object> params) throws IOException, TransformerException {
		testXsltTemplate(template, content, expected, params);
	}
