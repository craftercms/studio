...
public class XsltTest {
    ...
    public Object[][] getTestData() {
        return new Object[][] {
            ...
            new Object[] {
                    new ClassPathResource("/crafter/studio/upgrade/4.1.x/config/ui/ui-v4.1.3.1.xslt"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/ui/v4.1/4.1.3.1/input.xml"),
                    new ClassPathResource("crafter/studio/upgrade/xslt/ui/v4.1/4.1.3.1/expected.xml"),
                    emptyMap()
            },
            new Object[] {
