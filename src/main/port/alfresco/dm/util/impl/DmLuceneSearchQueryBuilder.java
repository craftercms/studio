...
import org.craftercms.cstudio.alfresco.util.impl.LuceneSearchQueryBuilder;

import java.util.List;

/**
 * lucene search query builder for DM
 *
 * @author hyanghee
 * @author Dejan Brkic
 *
 */
public class DmLuceneSearchQueryBuilder extends LuceneSearchQueryBuilder {
