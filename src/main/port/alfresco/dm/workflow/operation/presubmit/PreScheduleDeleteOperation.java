...
public class PreScheduleDeleteOperation extends SubmitLifeCycleOperation {
    ...
    public PreScheduleDeleteOperation(DmWorkflowService dmWorkflowService, Set<String> uris, Date date, GoLiveContext context, Set<String> rescheduledUris) {
    ...
    public Object execute() throws ServiceException {
        _dmWorkflowService.preScheduleDelete(_uris, _date, _context, _rescheduledUris);
        return null;
    }
}
