...
public interface DependencyService {
    ...
    /**
     * Delete dependencies for list of items from the database.
     *
     * @param site Site to operate on
     * @param paths List of paths to items to delete deps for
     * @throws SiteNotFoundException Site doesn't exist
     * @throws ContentNotFoundException Path doesn't exist
     * @throws ServiceException Internal error, see exception details
     */
    void deleteItemDependencies(String site, List<String> paths) throws SiteNotFoundException, ContentNotFoundException, ServiceException;
