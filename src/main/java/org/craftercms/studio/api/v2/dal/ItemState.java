...
public enum ItemState {
    ...
    public static final long PUBLISH_TO_LIVE_OFF_MASK =
            NEW.value + MODIFIED.value + USER_LOCKED.value + SYSTEM_PROCESSING.value + IN_WORKFLOW.value +  SCHEDULED.value + DESTINATION.value;
    ...
    public static final long PUBLISH_FAILED_OFF_MASK =
            USER_LOCKED.value + SYSTEM_PROCESSING.value + IN_WORKFLOW.value +  SCHEDULED.value;
