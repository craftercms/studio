...
public interface ItemMetadataDAO {
     ...
     * @return
     */
    List<SandboxItem> getChildrenById(@Param(SITE_ID) String siteId, @Param(PARENT_ID) String parentId,
                                      @Param(LEVEL_DESCRIPTOR_NAME) String ldName, @Param(LOCALE_CODE) String locale,
