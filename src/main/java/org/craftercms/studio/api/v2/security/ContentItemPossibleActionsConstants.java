...
public final class ContentItemPossibleActionsConstants {
    ...
    public static long LEVEL_DESCRIPTOR = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_EDIT + CONTENT_RENAME + CONTENT_CUT +
            CONTENT_DUPLICATE + CONTENT_REVERT + CONTENT_DELETE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;
    ...
    public static long ITEM_STATE_NEW = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;

    public static long ITEM_STATE_MODIFIED = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;

    public static long ITEM_STATE_DELETED = 0L;

    public static long ITEM_STATE_USER_LOCKED = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;

    public static long ITEM_STATE_SYSTEM_PROCESSING = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + CONTENT_CREATE + CONTENT_PASTE + CONTENT_UPLOAD + CONTENT_DUPLICATE +
            FOLDER_CREATE;

    public static long ITEM_STATE_IN_WORKFLOW = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;

    public static long ITEM_STATE_SCHEDULED = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;

    public static long ITEM_STATE_PUBLISHING = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
    ...
    public static long ITEM_STATE_STAGED = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + PUBLISH_REQUEST + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE + PUBLISH + PUBLISH_APPROVE + PUBLISH_SCHEDULE;

    public static long ITEM_STATE_LIVE = CONTENT_READ + CONTENT_COPY + CONTENT_READ_VERSION_HISTORY +
            CONTENT_GET_DEPENDENCIES + CONTENT_CREATE + CONTENT_PASTE + CONTENT_EDIT +
            CONTENT_RENAME + CONTENT_CUT + CONTENT_UPLOAD + CONTENT_DUPLICATE + CONTENT_CHANGE_TYPE + CONTENT_REVERT +
            CONTENT_EDIT_CONTROLLER + CONTENT_EDIT_TEMPLATE + FOLDER_CREATE + CONTENT_DELETE +
            CONTENT_DELETE_CONTROLLER + CONTENT_DELETE_TEMPLATE;

    public static long ITEM_STATE_TRANSLATION_UP_TO_DATE = 0L;

    public static long ITEM_STATE_TRANSLATION_PENDING = 0L;

    public static long ITEM_STATE_TRANSLATION_IN_PROGRESS = 0L;
