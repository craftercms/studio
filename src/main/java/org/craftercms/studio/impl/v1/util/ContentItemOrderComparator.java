...
public class ContentItemOrderComparator extends ContentComparatorBase<ContentItemTO> {
	 ...
	 * @param orderName
	 * @param ascending
	 * @param listFloatingPagesLast     if this is set to true, floating items will come last in the child list
	 * @param listLevelDescriptorsFirst if this is set to true, level descriptors will come first in the child list
	 */
