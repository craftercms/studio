...
public class DmContentLifeCycleServiceImpl extends AbstractRegistrableService implements DmContentLifeCycleService {
    ...
    @Override
    @ValidateParams
    public void process(@ValidateStringParam(name = "site") String site, @ValidateStringParam(name = "user") String user, @ValidateSecurePathParam(name = "path") String path, @ValidateStringParam(name = "contentType") String contentType, ContentLifeCycleOperation operation, Map<String, String> params) {
        if (operation == null) {
