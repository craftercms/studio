...
public class PathMappedContentRepository extends AbstractContentRepository {
   ...
   @Override
    ...
    public boolean copyContent(String site, String fromPath, String toPath) {
        ...
        return fromRepo.copyContent(site, fromPath, toPath);
    }
    ...
    public boolean moveContent(String site, String fromPath, String toPath) {
        ...
        return fromRepo.moveContent(site, fromPath, toPath);
    }
    ...
    public boolean moveContent(String site, String fromPath, String toPath, String newName) {
        ...
        return fromRepo.moveContent(site, fromPath, toPath, newName);
    }
