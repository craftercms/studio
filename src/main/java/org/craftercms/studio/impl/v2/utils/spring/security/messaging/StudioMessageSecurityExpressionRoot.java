...
public class StudioMessageSecurityExpressionRoot extends MessageSecurityExpressionRoot {
    ...
    public boolean isSystemAdmin() {
        try {
            ...
            logger.error1("Error checking groups for user {}", authentication.getName(), e);
        }
        return false;
    }
    ...
    public boolean isSiteMember(String siteId) {
        try {
            ...
            logger.error1("Error checking groups for user {} in site {}", authentication.getName(), siteId, e);
        }
        return false;
    }
