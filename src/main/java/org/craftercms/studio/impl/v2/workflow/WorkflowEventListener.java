...
public class WorkflowEventListener {
    ...
    public void handleEvent(final WorkflowEvent event) throws ServiceLayerException {
        ...
        /*
        Package metadata (like submitter, comment, date, time, etc.)
The first 10 file names from the package and indication if there is more
These can be links to the files, as suggested by Jonathan
A link to Crafter Studio (deep link to the package would be great, but we don't do this yet, but can be a future goal)
         */
