...
public class PublishRequestBody {
    ...
    @NotEmpty
    private List<@ValidateSecurePathParam @EsapiValidatedParam(type = HTTPURI) @NotBlank String> items;
    private List<@ValidateSecurePathParam @EsapiValidatedParam(type = HTTPURI) @NotBlank String> optionalDependencies;
    @NotEmpty
