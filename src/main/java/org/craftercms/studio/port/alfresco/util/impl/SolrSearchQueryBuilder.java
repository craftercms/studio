...
public class SolrSearchQueryBuilder implements SearchQueryBuilder {

    private static final Logger logger = LoggerFactory.getLogger(SolrSearchQueryBuilder.class);
