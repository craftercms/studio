 ...
 * @author avasquez
 */
public class RolePermissionResolverImpl implements PermissionResolver<String, Map<String, Object>> {
    ...
    public Permission getPermission(String username, Map<String, Object> resourceIds) throws PermissionException {
        ...
        Set<String> allowedRoles = securityService.getUserRoles(siteName, username, true);

        RolePermission permission = new RolePermission();
        permission.setAllowedRoles(allowedRoles);
