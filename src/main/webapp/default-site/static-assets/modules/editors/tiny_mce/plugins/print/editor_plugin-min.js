(function(){tinymce.create("tinymce.plugins.Print",{init:function(d,c){d.addCommand("mcePrint",function(){d.getWin().print()
});
d.addButton("print",{title:"print.print_desc",cmd:"mcePrint"})
