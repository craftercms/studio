...
tinymce.create("tinymce.plugins.CStudioContextMenu",{init:function(e){var h=this,f,d,i;
h.editor=e;
d=e.settings.contextmenu_never_use_native;
h.onContextMenu=new tinymce.util.Dispatcher(this);
f=e.onContextMenu.add(function(j,k){if(((i!==0?i:k.ctrlKey)&&!d)||tinymce.DOM.hasClass(k.target,".context-menu-off")||tinymce.DOM.getParents(k.target,".context-menu-off").length){return
}a.cancel(k);
if(k.target.nodeName=="IMG"){j.selection.select(k.target)
...
e.onDeactivate.add(function(j){g(j,null)
})
