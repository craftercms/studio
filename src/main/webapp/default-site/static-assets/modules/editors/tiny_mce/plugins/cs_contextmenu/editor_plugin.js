...
(function() {
	 ...
	 */
	tinymce.create('tinymce.plugins.CStudioContextMenu', {
		/**
		...
		init : function(ed) {
			...
			showMenu = ed.onContextMenu.add(function(ed, e) {
				...
				if (((realCtrlKey !== 0 ? realCtrlKey : e.ctrlKey) && !contextmenuNeverUseNative) ||
						tinymce.DOM.hasClass(e.target, ".context-menu-off") || tinymce.DOM.getParents(e.target, ".context-menu-off").length)
					return;
