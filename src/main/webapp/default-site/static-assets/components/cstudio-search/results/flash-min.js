CStudioSearch.ResultRenderer.Flash={render:function(g){var f="";
var e=g.item.uri;
...
}return CStudioSearch.renderCommonResultWrapper(g,"<span class='cstudio-search-component-title-nopreview'>"+g.item.internalName+(g.item.newFile?"*":"")+"</span><span class='cstudio-search-download-additional' style='margin-left:0px;'> | Flash</span><div class='cstudio-search-description'>"+d+"<div><span class='cstudio-search-download-additional'>Created: "+CStudioAuthoring.Utils.formatDateFromStringNullToEmpty(g.item.eventDate,"simpleformat")+"</span><br /><span class='cstudio-search-download-additional'>Edited "+CStudioAuthoring.Utils.formatDateFromString(g.item.eventDate,"simpleformat")+" by "+CStudioAuthoring.Utils.getAuthorFullNameFromContentTOItem(g.item)+"</span></div><div class='cstudio-search-description'>"+f+"</div>")
