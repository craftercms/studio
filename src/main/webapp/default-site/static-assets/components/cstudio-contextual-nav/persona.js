								...
								var currentProfile = eval("(" + json + ")");
									...
									"/targeting/personas/personas-config.xml", {
										success: function(config) {
											...
											imageEl.src = CStudioAuthoringContext.baseUri + '/api/1/service/api/1/content/get-content-at-path.json?path=/cstudio/config/sites/' + CStudioAuthoringContext.site + "/targeting/personas/thumbs/"+persona.thumb;
										},
