...
SELECT null,
       ...
       1,
       'ready',
       IFNULL(NULLIF(sandboxBranch, ''), 'master'),
       s.published_repo_created,
       'INITIALIZING'
FROM site s
WHERE s.site_id = sourceSiteId
  AND s.deleted = 0;
...
SELECT null,
       ...
       r.remote_password,
       r.remote_token,
       r.remote_private_key
FROM remote_repository r
WHERE r.site_id = sourceSiteId;

INSERT INTO dependency (id, site, source_path, target_path, type, valid)
SELECT null, siteId, d.source_path, d.target_path, d.type, d.valid
FROM dependency d
WHERE d.site = sourceSiteId;
...
SELECT null,
       i.record_last_updated,
       (SELECT id FROM site WHERE site_id = siteId AND deleted = 0),
       i.path,
       i.preview_url,
       i.state,
       i.locked_by,
...
FROM site
WHERE site_id = siteId
  AND deleted = 0 INTO @siteNumericId;

INSERT INTO navigation_order_sequence (folder_id, site, path, max_count)
SELECT UUID(), siteId, nos.path, nos.max_count
FROM navigation_order_sequence nos
WHERE nos.site = sourceSiteId;

SELECT id
FROM site
WHERE site_id = sourceSiteId
  AND deleted = 0 INTO @sourceSiteNumericId;
...
INSERT INTO _meta (version, studio_id)
VALUES ('4.2.0.17', UUID());
...
(
    ...
    `primary_target_id` VARCHAR
(
    1024
) NOT NULL,
    `primary_target_type` VARCHAR
(
    32
) NOT NULL,
    `primary_target_subtype` VARCHAR
(
    32
) NULL,
    `primary_target_value` VARCHAR
(
    1024
) NOT NULL,
    `actor_id` VARCHAR
...
(
    ...
    KEY `audit_operation_idx`
(
    `operation`
),
    KEY `audit_origin_idx`
(
    `origin`
),
    KEY `audit_primary_target_value_idx`
(
...
(
    ...
    FOREIGN KEY `audit_parameters_ix_audit_id`
(
    `audit_id`
) REFERENCES `audit`
(
    ...
    ON DELETE CASCADE,
    KEY `audit_parameters_target_id_idx`
(
    `target_id`
),
    KEY `audit_parameters_target_value_idx`
(
    `target_value`
)
    )
...
(
    ...
    KEY `dependency_site_idx`
(
    `site`
),
    KEY `dependency_sourcepath_idx`
(
    `source_path`
(
    1000
)),
    KEY `dependency_targetpath_idx`
(
    `target_path`
(
    1000
...
(
    ...
    KEY `navigationorder_folder_idx`
(
    `folder_id`
)
    )
...
(
    ...
    UNIQUE INDEX `site_uuid_site_id_unique`
(
    `site_uuid`
    ASC,
    `site_id`
...
(
    ...
    UNIQUE INDEX `ingested_commits_commit_id_site_id`
(
    `commit_id`,
    `site_id`
),
    FOREIGN KEY `ingested_commits_site_id`
(
    `site_id`
) REFERENCES `site`
(
...
(
    ...
    INDEX `user_ix_record_last_updated`
(
    `record_last_updated`
    DESC
),
    UNIQUE INDEX `user_ix_username`
(
    `username`
),
    INDEX `user_ix_first_name`
(
    `first_name`
),
    INDEX `user_ix_last_name`
(
    `last_name`
)
    )
...
INSERT
IGNORE INTO `user` (id, record_last_updated, username, password, first_name, last_name,
...
(
    ...
    INDEX `organization_ix_record_last_updated`
(
    `record_last_updated`
    DESC
),
    UNIQUE INDEX `organization_ix_org_name`
(
    `org_name`
)
    )
...
INSERT
IGNORE INTO `organization` (id, record_last_updated, org_name, org_desc)
...
(
    ...
    FOREIGN KEY org_member_ix_user_id
(
    user_id
) REFERENCES `user`
(
    ...
    FOREIGN KEY org_member_ix_org_id
(
    org_id
...
(
  ...
  ON DELETE CASCADE,
    INDEX `org_member_ix_record_last_updated`
(
    `record_last_updated`
    DESC
)
...
INSERT
IGNORE INTO `organization_user` (user_id, org_id)
VALUES (1, 1) ;
...
(
    ...
    INDEX `group_ix_record_last_updated`
(
    `record_last_updated`
    DESC
),
    FOREIGN KEY group_ix_org_id
(
    org_id
) REFERENCES `organization`
(
    ...
    UNIQUE INDEX `group_ix_group_name`
(
    `group_name`
)
    )
...
INSERT
IGNORE INTO `group` (id, record_last_updated, org_id, group_name, group_description, externally_managed)
...
(
    ...
    FOREIGN KEY group_member_ix_user_id
(
    `user_id`
) REFERENCES `user`
(
    ...
    ON DELETE CASCADE,
    FOREIGN KEY group_member_ix_group_id
(
    `group_id`
) REFERENCES `group`
(
    ...
    ON DELETE CASCADE,
    INDEX `group_member_ix_record_last_updated`
(
    `record_last_updated`
    DESC
)
...
(
    ...
    FOREIGN KEY item_ix_created_by
(
    `created_by`
) REFERENCES `user`
(
    ...
    FOREIGN KEY item_ix_last_modified_by
(
    `last_modified_by`
) REFERENCES `user`
(
...
(
    ...
    FOREIGN KEY `item_translation_ix_source`
(
    `source_id`
) REFERENCES `item`
(
    `id`
                                                                       ...
                                                                       ON DELETE CASCADE,
    FOREIGN KEY `item_translation_ix_translation`
(
    `translation_id`
) REFERENCES `item`
(
...
(
    ...
    UNIQUE `uq_rr_site_remote_name`
(
    `site_id`,
    `remote_name`
),
    INDEX `remoterepository_site_idx`
(
    `site_id`
    ASC
)
...
(
    ...
    `git_remote_name` VARCHAR
(
    255
) NOT NULL,
    `git_auth_type` VARCHAR
(
    16
) NOT NULL,
...
(
    ...
    UNIQUE `uq_cl_git_url`
(
    `git_url`
),
    UNIQUE `uq_cl_git_remote_name`
(
    `git_remote_name`
)
    )
...
(
    ...
    `published_staging_commit_id` CHAR
(
    40
),
    `published_live_commit_id` CHAR
(
    40
),
    PRIMARY KEY
(
    ...
    FOREIGN KEY `publish_package_site_id`
(
    `site_id`
) REFERENCES `site`
(
    ...
    FOREIGN KEY `publish_package_submitter_id`
(
    `submitter_id`
) REFERENCES `user`
(
    ...
    FOREIGN KEY `publish_package_reviewer_id`
(
    `reviewer_id`
) REFERENCES `user`
(
    ...
    INDEX `publish_package_package_state`
(
    `package_state`
)
    )
...
(
    ...
    `live_previous_path` VARCHAR
(
    2048
),
    `staging_previous_path` VARCHAR
(
    2048
),
    `action` ENUM
...
(
    ...
    FOREIGN KEY `publish_item_package_id`
(
    `package_id`
) REFERENCES `publish_package`
(
    `id`
) ON DELETE CASCADE
    )
...
(
    ...
    FOREIGN
    KEY
    `item_publish_item_publish_item_id`
(
    `publish_item_id`
) REFERENCES `publish_item`
(
    `id`
) ON DELETE CASCADE,
    FOREIGN KEY `item_publish_item_item_id`
(
    `item_id`
) REFERENCES `item`
(
...
(
    ...
    FOREIGN KEY `item_target_item_id`
(
    `item_id`
) REFERENCES `item`
(
...
INSERT
IGNORE INTO site (site_id, name, description, system, state)
VALUES ('studio_root', 'Studio Root', 'Studio Root for global permissions', 1, 'READY') ;

INSERT
IGNORE INTO group_user (user_id, group_id) VALUES (1, 1) ;
