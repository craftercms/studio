...
(
    ...
    SITE_ID BIGINT CONSTRAINT GROUP_SITE_FK REFERENCES CSTUDIO_SITE ON DELETE CASCADE,
    UNIQUE (NAME)
) ;
...
(
    ID BIGINT PRIMARY KEY NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
    USERNAME VARCHAR(255) NOT NULL CONSTRAINT USER_UG_FOREIGN_KEY REFERENCES CSTUDIO_USER ON DELETE CASCADE,
    GROUPID BIGINT NOT NULL CONSTRAINT GROUP_UG_FOREIGN_KEY REFERENCES CSTUDIO_GROUP ON DELETE CASCADE
) ;
