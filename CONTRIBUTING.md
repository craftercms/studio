...
When contributing to this repository, please first discuss the change you wish to make via IRC (freenode.net, 
...
3. If the work you're contributing requires documentation, please make sure you you send an accompanying PR to the 
[documentation project.](https://github.com/craftercms/docs)
...
reported by contacting the project team at [abuse@craftercms.org](mailto:abuse@craftercms.org). All
